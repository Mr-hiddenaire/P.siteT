...
Complete membership plugin to turn your site into a membership website. sell subscriptions, content restriction, profiles & directories, signups
...
[ARMember membership plugin](https://www.armemberplugin.com) is complete membership system which will help you to build fully functional membership site.
...
[Content Restriction](https://www.armemberplugin.com/content-restriction/ "Content Restriction") is key part of any membership wordpress plugin. ARMember provides super easy interface that you can restrict any content of your site with just one click. And above all, you can restrict partial content of any page/post by placing just one shortcode.

<p>&nbsp;</p>
[youtube https://www.youtube.com/watch?v=8COXGo-NetQ]
<p>&nbsp;</p>

###Here are some unique features of ARMember membership plugin
...
* Facility to extend membership next payment due date and expiry date
...
* Facility to upgrade/downgrade/renew membership/cancel membership
* Visual Composer, Cornerstone Integrated
...
###ARMEMBER Membership Premium/Pro plugin's most amazing features:

* **Pay Per Post**
  With this feature, you can sell post/course separately without creating plan(s).

* **Multiple payment cycle per plan**
  Offer multiple payment cycles like monthly, yearly etc for the same membership plan. Let user decide which cycle they want to go with.
...
* **Social Login/connect**
  ARmember membership plugin provides a popular Social media configuration - Facebook, twitter, linkedin, vk.

* **Member Profile & Directory Templates**
  ARMember membership plugin provides wide range of beautiful templates for member profile and directory with many template customization options.

* **Exclusive Coupon Management**
  Configure various type of coupons including plan specific coupons.

* **Opt-ins (Email Marketers)**
  ARMember membership plugin offers email marketing softwares like Aweber, Mailchimp, Constant Contact.
...
###Lots of addons to extend ARMember membership plugin's features:
...
7. ARMember Membership Plugin - Member Profile preview
