		...
		<form  method="post" action="#" id="arm_redirection_settings" class="arm_admin_form">
            ...
            */?>
               ...
               <div class="arm_submit_btn_container arm_redirection_submit_btn">
				<button class="arm_save_btn arm_redirection_settings_btn" type="submit" id="arm_redirection_settings_btn" name="arm_redirection_settings_btn"><?php _e('Save', 'ARMember') ?></button>&nbsp;<img src="<?php echo MEMBERSHIPLITE_IMAGES_URL.'/arm_loader.gif' ?>" id="arm_loader_img" style="position:relative;top:8px;display:none;" width="24" height="24" />
